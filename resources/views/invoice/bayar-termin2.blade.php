                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            @endif
                            <form action="/update-termin2/{{ $invoice->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="termin1" name="termin1"
                                                    placeholder="Termin 1" value="{{ $invoice->termin1 }}" readonly>
                                            </div>
                                            @if ($invoice->termin1 == 0)
                                                <div class="form-group">
                                                    <label for="total-paid">Termin 2</label>
                                                    <input type="text" class="form-control" id="termin2"
                                                        name="termin2" value="0" placeholder="Termin 2" readonly>
                                                </div>
                                            @else
                                                <div class="form-group">
                                                    <label for="total-paid">Termin 2</label>
