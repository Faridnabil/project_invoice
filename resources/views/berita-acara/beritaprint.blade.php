            ...
            <tr>
                <td colspan="12">
                    ...
                    <p style="text-align: justify;">
                        dalam hal ini bertindak atas nama {{ $bast->invoice->quotation->customer_name }} dan selanjutnya disebut <b>PIHAK
                            KEDUA</b>. <br><br>
                        <b>PIHAK PERTAMA</b> dan <b>PIHAK KEDUA</b> secara bersama-sama (selanjutnya disebut sebagai
                        <b>PARA PIHAK</b>). <br><br>
                        Berdasarkan Surat Perjanjian Kerja Sama dengan referensi nomor invoice {{ date('d.m', strtotime($bast->invoice->created_at)) }}/
