                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-toolbar">
                                ...
                                <button
                                    ...
                                    <span class="svg-icon svg-icon-1 svg-icon-gray-300 me-n1"><svg width="24"
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-toolbar d-none">
                                ...
                                <div data-kt-daterangepicker="true" data-kt-daterangepicker-opens="left"
                                    ...
                                    <span class="svg-icon svg-icon-1 ms-2 me-0"><svg width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-senter">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-success me-2"><svg width="24"
                                            height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-senter">
                                    ...
                                    <span class="svg-icon svg-icon-2 svg-icon-danger me-2"><svg width="24"
                                            height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-xxl-4 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-header pt-7 mb-5">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="../demo1/apps/ecommerce/sales/listing.html" class="btn btn-sm btn-light">View
                                    All</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="m-0">
                                                ...
                                                <span class="badge badge-light-danger fs-base">
                                                    ...
                                                    <span class="svg-icon svg-icon-5 svg-icon-danger ms-n1"><svg
                                                            width="24" height="24" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="card card-flush h-xl-100"
                        ...
                        <div
                            ...
                            <img class="mx-auto h-150px h-lg-200px mb-11"
                                src="assets/media/svg/illustrations/sigma/illustration-realestate.svg" alt="" />
                            <!--end::Illustration-->
                        </div>
                        <!--end::Body-->
                    </div>
